...
TRADE_MODE=paper (default)
    -> preserves the user's existing V16 Champion/Challenger Forward Paper.

TRADE_MODE=live
    -> Strategy v2.0 / Meta SAFE v1.1 real Binance USDⓈ-M Futures trading.

The bot can keep importing:
    ...
    def __init__(self, bot, tz, fallback_channel_id=None):
        ...
        if mode=="live":
            ...
            self._impl=LiveStrategyV2DiscordBridge(
                bot,tz,fallback_channel_id=fallback_channel_id
            )
        elif mode=="paper":
